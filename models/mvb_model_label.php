...
class mvb_Model_Label {
    ...
    public static function initLabels() {
        ...
        self::$labels['LABEL_44'] = __('Post Title', 'aam');
        self::$labels['LABEL_45'] = __('Post Type', 'aam');
        self::$labels['LABEL_46'] = __('Type', 'aam');
        self::$labels['LABEL_47'] = __('Status', 'aam');
        self::$labels['LABEL_48'] = __('Current Post Status', 'aam');
        self::$labels['LABEL_49'] = __('Visibility', 'aam');
        self::$labels['LABEL_50'] = __('Current Post Visibility Status', 'aam');
        ...
        self::$labels['LABEL_61'] = __('Update info for all roles', 'aam');
        self::$labels['LABEL_62'] = __('Update All', 'aam');
        self::$labels['LABEL_63'] = __('Category', 'aam');
        self::$labels['LABEL_64'] = __('Category title', 'aam');
        self::$labels['LABEL_65'] = __('Post Taxonomy name', 'aam');
        self::$labels['LABEL_66'] = __('Posts', 'aam');
        self::$labels['LABEL_67'] = __('Number of posts in Category', 'aam');
        self::$labels['LABEL_68'] = __('Restrict access to current Category and for all Sub Categories and Posts that are related to these Categories and Sub Categories', 'aam');
        self::$labels['LABEL_69'] = __('Restrict access to current Category and for all Sub Categories and Posts that are related to these Categories and Sub Categories', 'aam');
        self::$labels['LABEL_70'] = __('If Restric Front or Restrict Admin is checked then restrict access to current Category and all Sub Categories, and Posts till the specified date. If Restrict is unchecked then allow access to current Category and all Sub Categories, and Posts till the specified date', 'aam');
        ...
        self::$labels['LABEL_92'] = __('Support & Social', 'aam');
        self::$labels['LABEL_93'] = __('Support Forum', 'aam');
